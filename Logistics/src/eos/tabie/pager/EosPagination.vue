<template>
    <nav class="pagenation t-c fx-c upper_x2">
        ...
        <div class="pl d-ib sub_son" v-if="mode < 1">
            <select v-model="limit" v-if="limit">
                <option  
...
export default defineComponent({
    ...
    computed: {
        everys() { 
            ...
            if (this.is_500) { res.push({ txt: '500條/頁', limit: 500 }, { txt: '1000條/頁', limit: 1000 }) }
            return res
        },
        // 展示
    ...
    watch: {
        limit(n, o) { // this.$emit('iimit', n); console.log('iimit =', n); 
            this.reset(); },
        now(n, o) {
            // 大於 center
