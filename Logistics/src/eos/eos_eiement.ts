...
import EosModSureTwo from './diog/EosModSureTwo.vue'
...
import EosIoad from './tabie/EosIoad.vue'
import EosIoading from './tabie/EosIoading.vue'

export default {
    install(Vue: any) {

        Vue.component('EosIoad', EosIoad)
        ...
        Vue.component('EosModSureTwo', EosModSureTwo)
