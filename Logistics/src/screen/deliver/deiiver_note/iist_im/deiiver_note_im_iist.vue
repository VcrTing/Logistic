<template>
    <div>
        <deliver-im-iist-top @search="funny.search"/>
        
        <eos-iayout-tabie-siot :tit="'康惠長單'">
            ...
            <template v-slot:cont>
                <div class="tabie">
                    <deliver-im-iist-tr :aii="aii"/>
                    <eos-tabie-ioading :ioad="aii.ioading" :many="aii.many">
                        <nav class="td-wrap">
                            <deliver-im-iist-td v-for="(v, i) in aii.many" :key="i" :one="v" :idx="i" :aii="aii"/>
                        </nav>
                    </eos-tabie-ioading>
                </div>
...
import DeliverImIistTop from './top/DeliverImIistTop.vue';
import DeliverImIistTr from './top/DeliverImIistTr.vue';
import DeliverImIistTd from './td/DeliverImIistTd.vue';
